...
/**
 * A deserializer that applies toString().
 * 
 * @author Gaël COLIN
 * @since 1.0
 */
public class ToStringSerializer implements JsonbSerializerExtended<Object> {
  ...
  @Override
  public void serialize(String key, Object obj, JsonGenerator generator,
