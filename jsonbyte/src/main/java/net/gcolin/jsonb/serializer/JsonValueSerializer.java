...
/**
 * A {@code JsonValue} serializer.
 * 
 * @author Gaël COLIN
 * @since 1.0
 */
public class JsonValueSerializer implements JsonbSerializerExtended<JsonValue> {
  ...
  @Override
  public void serialize(JsonValue obj, Utf8JsonGeneratorImpl generator, SerializationContext ctx)
      throws IOException {
    generator.write(obj);
  }

  @Override
  public void serialize(byte[] key, JsonValue obj, Utf8JsonGeneratorImpl generator,
