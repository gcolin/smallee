...
/**
 * A {@code BigInteger} serializer.
 * 
 * @author Gaël COLIN
 * @since 1.0
 */
public class BigIntegerSerializer implements JsonbSerializerExtended<BigInteger> {
  ...
  @Override
  public void serialize(String key, BigInteger obj, JsonGenerator generator,
      SerializationContext ctx) {
    generator.write(key, obj);
  }

  @Override
  public void serialize(BigInteger obj, Utf8JsonGeneratorImpl generator, SerializationContext ctx)
      throws IOException {
    generator.write0(obj.toString());
  }

  @Override
  public void serialize(byte[] key, BigInteger obj, Utf8JsonGeneratorImpl generator,
