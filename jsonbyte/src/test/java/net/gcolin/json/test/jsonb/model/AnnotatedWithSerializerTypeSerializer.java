 ...
 */
public class AnnotatedWithSerializerTypeSerializer
    implements JsonbSerializer<AnnotatedWithSerializerType> {

  @Override
  public void serialize(AnnotatedWithSerializerType obj, JsonGenerator generator,
