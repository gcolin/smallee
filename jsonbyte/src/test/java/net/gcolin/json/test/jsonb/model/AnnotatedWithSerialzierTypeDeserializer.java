 ...
 */
public class AnnotatedWithSerialzierTypeDeserializer
    implements JsonbDeserializer<AnnotatedWithSerializerType> {
  /**
   ...
   */
  @Override
  public AnnotatedWithSerializerType deserialize(JsonParser parser, DeserializationContext ctx,
      Type rtType) {
