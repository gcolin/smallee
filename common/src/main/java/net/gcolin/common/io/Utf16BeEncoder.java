      ...
      if (Character.isSurrogate(chr)) {
        if (Character.isHighSurrogate(chr)) {
          ...
          if (Character.isLowSurrogate(c2)) {
            ...
            put(ptr, buf, 0xd800 | (((character - UCS4_MIN) >> 10) & 0x3ff));
            put(ptr + 2, buf, 0xdc00 | ((character - UCS4_MIN) & 0x3ff));
            ptr += 4;
          } else {
            throwBadEncoding();
          }
