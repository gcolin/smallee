...
public class Scan {
  ...
  /**
   * Transform a URL of a file in a jar to a the URL of the jar Used by JarProvider.
   * 
   ...
   * Scan classes.
   * 
   * @param url the URL of the root path to scan or the URL of a file in a jar
