...
import net.gcolin.rest.servlet.HttpServletRequestParam;
 ...
 * @since 1.0
 */
public class HttpServletRequestParamTest {
  ...
  public void updateTest() {
    ...
    HttpServletRequestParam param = new HttpServletRequestParam();
    Assert.assertEquals(req, param.update(rc));
  }
