...
import net.gcolin.rest.servlet.ServletConfigParam;
 ...
 * @since 1.0
 */
public class ServletConfigParamTest {
  ...
  public void updateTest() {
    ...
    Mockito.when(exchange.getConfig()).thenReturn(config);

    ServletConfigParam param = new ServletConfigParam();
    Assert.assertEquals(config, param.update(rc));
  }
