...
/**
 * The QueryParam extracts a QueryParam from the request.
 * 
 * @author Gaël COLIN
 * @since 1.0
 * @see javax.ws.rs.QueryParam
 */
public class QueryParam extends ParsableParam {
  ...
  public Object update(ServerInvocationContext context) throws IOException {
    return update(context.getUriInfo().getQueryParameters().getFirst(name));
  }
