...
public class InputStreamProvider extends Provider<InputStream> {
  ...
  @Override
  public void writeTo(InputStream entity, Class<?> type, Type genericType, Annotation[] annotations,
