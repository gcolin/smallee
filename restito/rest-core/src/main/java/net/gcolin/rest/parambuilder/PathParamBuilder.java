...
import net.gcolin.rest.param.PathParam;
 ...
 *
 */
public class PathParamBuilder implements ParamBuilder {

  private ParamConverterProvider paramProvider;

  public PathParamBuilder(ParamConverterProvider paramProvider) {
  ...
  public Param build(Class<?> type, Type genericType, Annotation[] annotations, boolean multipart,
    ...
    ParsableParam pp = new PathParam(((javax.ws.rs.PathParam) annotation).value());
