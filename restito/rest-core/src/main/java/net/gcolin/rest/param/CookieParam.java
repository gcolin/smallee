...
/**
 * The CookieParam extracts a cookie from the request.
 * 
 * @author Gaël COLIN
 * @since 1.0
 * @see javax.ws.rs.CookieParam
 */
public class CookieParam extends ParsableParam {

  private String name;

  public CookieParam(String name) {
    this.name = name;
  }
  ...
  public Object update(ServerInvocationContext context) throws IOException {
    ...
    return super.update(cookie == null ? null : cookie.getValue());
  }
}
