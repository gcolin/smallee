...
/**
 * A ConstraintValidator Digits for a Number.
 * 
 * @author Gaël COLIN
 * @since 1.0
 */
public class DigitsNumberValidator implements ConstraintValidator<Digits, Number> {
  ...
  private DigitsStringValidator delegate = new DigitsStringValidator();
  ...
  public boolean isValid(Number value, ConstraintValidatorContext context) {
    ...
    return delegate.isValid(value.toString(), context);
  }
