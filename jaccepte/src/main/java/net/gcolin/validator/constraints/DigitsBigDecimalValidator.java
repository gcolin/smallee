...
/**
 * A ConstraintValidator Digits for a BigDecimal.
 * 
 * @author Gaël COLIN
 * @since 1.0
 */
public class DigitsBigDecimalValidator implements ConstraintValidator<Digits, BigDecimal> {
  ...
  public boolean isValid(BigDecimal value, ConstraintValidatorContext context) {
    ...
    int integerPartLength = value.precision() - scale;
