...
/**
 * A ConstraintValidator DecimalMax for a BigInteger.
 * 
 * @author Gaël COLIN
 * @since 1.0
 */
public class DecimalMaxBigIntegerValidator implements ConstraintValidator<DecimalMax, BigInteger> {
  ...
  public boolean isValid(BigInteger value, ConstraintValidatorContext context) {
    return value == null || new BigDecimal(value).compareTo(max) <= 0;
  }
