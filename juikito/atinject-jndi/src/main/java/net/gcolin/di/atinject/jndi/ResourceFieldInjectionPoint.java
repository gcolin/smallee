...
/**
 * Inject a JNDI resource.
 * 
 * @author Gaël COLIN
 * @since 1.0
 */
public class ResourceFieldInjectionPoint extends ResourceInjectionPoint implements InjectionPoint {

  private Field field;

  public ResourceFieldInjectionPoint(String name, Field field) {
    super(name);
    this.field = field;
